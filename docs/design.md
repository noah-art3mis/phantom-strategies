...
The whole page stays near-black. Mint identifies controls; rainbow interference belongs to the artwork and headline, as explicitly requested. Manrope supplies the display and body type. Inputs and strategy groups have 8 px corners, primary buttons 6 px, and the small motion control is pill-shaped. The page uses an asymmetric hero, the working oracle form, and a quieter illustrated explanation. Mobile places the apparition below the title and collapses strategy choices into two columns.
